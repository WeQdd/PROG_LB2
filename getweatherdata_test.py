...
key = '01d86358876a2a23de00b4810ecad058'


def test_without_key():
    assert getweatherdata.get_weather_data(
        "moscow", api_key=key) is None, \
...
print(getweatherdata.get_weather_data('Chicago', api_key=key))
print(getweatherdata.get_weather_data('Saint Petersburg', api_key=key))
print(getweatherdata.get_weather_data('Dhaka', api_key=key))